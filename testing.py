...
score1 = model.evaluate(cir, cir_l)
print(score1)
val_result1 = np.zeros(val_pred1.shape)                                                                                                                                                        
val_result1[val_pred1>0.5] = 1
dcoef1 = dc(val_result1,cir_l)
prec1  = precision(val_result1,cir_l)
rec1   = recall(val_result1,cir_l)
dcoefarr1.append(dcoef1)
precisionavg1.append(prec1)
recavg1.append(rec1)
...
score1 = model.evaluate(nid, nid_l)
print(score1)
val_result1 = np.zeros(val_pred1.shape)                                                                                                                                                        
val_result1[val_pred1>0.5] = 1
dcoef1 = dc(val_result1, nid_l)
prec1  = precision(val_result1, nid_l)
rec1   = recall(val_result1, nid_l)
dcoefarr1.append(dcoef1)
precisionavg1.append(prec1)
recavg1.append(rec1)
print("Precision: ----------------------------------------------------------------------------",prec1)
...
score1 = model.evaluate(spe, spe_l)
print(score1)
val_result1 = np.zeros(val_pred1.shape)                                                                                                                                                        
val_result1[val_pred1>0.5] = 1
dcoef1 = dc(val_result1,spe_l)
prec1  = precision(val_result1,spe_l)
rec1   = recall(val_result1,spe_l)
dcoefarr1.append(dcoef1)
precisionavg1.append(prec1)
recavg1.append(rec1)
print("Precision: ----------------------------------------------------------------------------",prec1)
...
score1 = model.evaluate(top, top_l)
print(score1)
val_result1 = np.zeros(val_pred1.shape)                                                                                                                                                        
val_result1[val_pred1>0.5] = 1
dcoef1 = dc(val_result1,top_l)
prec1  = precision(val_result1,top_l)
rec1   = recall(val_result1,top_l)
dcoefarr1.append(dcoef1)
precisionavg1.append(prec1)
recavg1.append(rec1)
print("Precision: ----------------------------------------------------------------------------",prec1)
...
cir=np.concatenate((res1[0:255],res2[0:255]),axis=0)
cir_l=np.concatenate((test1_y2[0:255],test2_y2[0:255]),axis=0)
...
prec1  = precision(val_result1,cir_l)
rec1   = recall(val_result1,cir_l)
dcoefarr2.append(dcoef1)
precisionavg2.append(prec1)
recavg2.append(rec1)
print("Precision: ----------------------------------------------------------------------------",prec1)
print("recall: ----------------------------------------------------------------------------",rec1)
...
############################----------2
nid=np.concatenate((res1[256:265],res2[256:260]),axis=0)
nid_l=np.concatenate((test1_y2[256:265],test2_y2[256:260]),axis=0)
...
################################################
spe=np.concatenate((res1[266:363],res2[261:274]),axis=0)
spe_l=np.concatenate((test1_y2[266:363],test2_y2[261:274]),axis=0)
...
top=np.concatenate((res1[364:619],res2[275:281]),axis=0)
top_l=np.concatenate((test1_y2[364:619],test2_y2[275:281]),axis=0)
...
cir=np.concatenate((res1[0:255],res2[0:255]),axis=0)
cir_l=np.concatenate((test1_y3[0:255],test2_y3[0:255]),axis=0)
...
prec1  = precision(val_result1,cir_l)
rec1   = recall(val_result1,cir_l)
dcoefarr3.append(dcoef1)
precisionavg3.append(prec1)
recavg3.append(rec1)
print("Precision: ----------------------------------------------------------------------------",prec1)
print("recall: ----------------------------------------------------------------------------",rec1)
...
############################----------2
nid=np.concatenate((res1[256:265],res2[256:260]),axis=0)
nid_l=np.concatenate((test1_y3[256:265],test2_y3[256:260]),axis=0)
...
################################################
spe=np.concatenate((res1[266:363],res2[261:274]),axis=0)
spe_l=np.concatenate((test1_y3[266:363],test2_y3[261:274]),axis=0)
...
top=np.concatenate((res1[364:619],res2[275:281]),axis=0)
top_l=np.concatenate((test1_y3[364:619],test2_y3[275:281]),axis=0)
...
#############################################
print
print("-----------------------------AVERAGE of label1----------------------")
print("Average Precision:------------------------------------------------ ",np.mean(precisionavg1))
print("Average recall: -----------------------------------------------------",np.mean(recavg1))

print ("Average Dice: ----------------------------------------------------------",np.mean(dcoefarr1))



print
print("-----------------------------AVERAGE of label2----------------------")
print("Average Precision:------------------------------------------------ ",np.mean(precisionavg2))
print("Average recall: -----------------------------------------------------",np.mean(recavg2))

print ("Average Dice: ----------------------------------------------------------",np.mean(dcoefarr2))

print
print("-----------------------------AVERAGE of label3----------------------")
print("Average Precision:------------------------------------------------ ",np.mean(precisionavg3))
print("Average recall: -----------------------------------------------------",np.mean(recavg3))

print ("Average Dice: ----------------------------------------------------------",np.mean(dcoefarr3))


print
print("-----------------------------OVERALL----------------------")
print("Average Precision:------------------------------------------------ ",(np.mean(precisionavg1)+np.mean(precisionavg2)+np.mean(precisionavg3))/3)
print("Average recall: -----------------------------------------------------",(np.mean(recavg1)+np.mean(recavg2)+np.mean(recavg3))/3)

print ("Average Dice: ----------------------------------------------------------",(np.mean(dcoefarr1)+np.mean(dcoefarr2)+np.mean(dcoefarr3))/3)
